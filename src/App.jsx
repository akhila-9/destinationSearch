...
import "./App.css";
import DestinationSearch from "./destinationCom/destinationSearch";
import DestinationItem from "./destincationitem/destinationItem";
...
function App() {
  const [place, setPlace] = useState(destinationsList);

  console.log(destinationsList);
  return (
    <>
 
  <DestinationSearch intial={place} setintial={setPlace} totalArr={destinationsList} />
      <div className="con">
        {place.map((each) => (
          <DestinationItem details={each} />
        ))}
      </div>
    </>
  );
